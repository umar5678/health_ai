...
const Input = forwardRef(function input(
  ...
  return (
    <div className={`flex flex-col ${className}`}>
      <label
        className={`text-gray-800 font-semibold text-sm  ${labelClasses} font-light`}
        htmlFor={id}
      >
        {label}
      </label>
      <input
        ...
        type={type}
        className={`text-gray-800  border border-gray-300  rounded-md   focus:outline-1 focus:outline-gray-300 dark:focus:outline-gray-300 bg-white ${inputClasses}`}
        ref={ref}
